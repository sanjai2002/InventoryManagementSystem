...
namespace InventoryManagementSystem.Controllers
{
    ...
    public class PurchaseController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult Getpurchasedetails([FromBody] GetRetailerid retailer)
        {
            var Purchasehistory = _dbcontext.Purchase.Include(x => x.Retailer).Include(x => x.SuperProduct).Where(s => s.Retailerid == retailer.Retailerid);
