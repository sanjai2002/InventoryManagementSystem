      ...
      <form  onSubmit={handleSubmit}>
        ...
        <div className="ui form">
          ...
          <div className="field">
            ...
            <input type="text"  data-testid="productcode-input"name="productcode" placeholder="Enter Productcode" onChange={e => setValues({ ...values, productcode: e.target.value })}/>
            <p ref={productcoderef}></p>
          </div>
          
          <div className="field">
            <label>productName</label>
            <input type="text"data-testid="productName-input" name="productName" placeholder="Enter ProductName" onChange={e => setValues({ ...values, productName: e.target.value })}/>
            <p ref={productNameref}></p>
          </div>

          <div className="field">
            <label>Product Category</label>
            <input type="text" data-testid="productCategory-input" name="productCategory" placeholder="Enter ProductCategory" onChange={e => setValues({ ...values, productCategory: e.target.value })}/>
            <p ref={productCategoryref}></p>
          </div>
          <div className="field">
            <label>Description</label>
            <input type="text" data-testid="description-input" name="description" placeholder="Enter Description" onChange={e => setValues({ ...values, description: e.target.value })}/>
          ...
          <div className="field">
            ...
            <div class="ui right labeled input">
              <input type="number" data-testid="buyingPrice-input" min="1" placeholder="Enter ProductionPrice" id="amount"onChange={e => setValues({ ...values, buyingPrice: e.target.value })} />
          ...
          <div className="field">
            ...
            <div class="ui right labeled input">
              <input type="number" data-testid="sellingPrice-input" min="1" placeholder="Enter SellingPrice" id="amount"onChange={e => setValues({ ...values, sellingPrice: e.target.value })} />
          ...
          <div className="field">
            ...
            <div class="ui right labeled input">
              <input type="Date" data-testid="productcode-input" placeholder="expiryDate"  min={new Date().toISOString().split('T')[0]} onChange={e => setValues({ ...values, expiryDate: e.target.value })} />
          ...
          <div className="field">
            <label>Stock</label>
            <div class="ui right labeled input">
              <input type="number" data-testid="stock-input"  min="1" placeholder="stock" onChange={e => setValues({ ...values, stock: e.target.value })} />
